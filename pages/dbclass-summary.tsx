...
const DbClassSummary = () => (
  <Layout page={meta.target}>
    ...
    <p>
      ...
      interested in online learning in general, or in this particular course
      (which will probably be repeated). I am also writing this summary for
      myself, so feel free to skip passages which seem too biographical.
    </p>
    <p>
      <Image
    ...
    <p>
      (Remark: If you are a creator of an online computer-science course, please
      have a look at this post’s section about automated exercises,
    ...
    <p>
      ...
      Africa.) Students’ ages and backgrounds seemed to differ wildly. According
      to a statistics page at the end of the course, there were 64127 registered
      students; 20836 turned in some work; 4854 received a “Statement of
      Accomplishment” (which can be seen as passing the course), and 1927
      received the harder-to-obtain “Statement of Accomplishment With
      Distinction”. Some observers thought this meant a very high dropout rate,
      but I disagree: considering that this course is free, and signing up is
      trivial, I find it impressive that almost a quarter of the people who
      turned in some work passed.
    </p>
    <p>
    ...
    <p>
      <ul>
        ...
        <li>
          ...
          preparing lots of downloadable material (which is be still available,
          on this blog). If I still were a lecturer, I might be attempting to
          give an online course today.
        </li>
        <li>
          Finally, I deem it possible that online courses like the Stanford one
          are spearheading a revolution in academic teaching, and I want to
    ...
    <h3>The lectures</h3>
    <p>
      The lectures are: Introduction, Relational Databases, XML Data, JSON Data,
      Relational Algebra, SQL, Relational Design Theory, Querying XML, UML,
      Indexes, Transactions, Constraints and Triggers, Views, Authorization,
      Recursion, Online Analytical Processing, NoSQL.
    </p>
    ...
    <h3>The exercises</h3>
    <p>
      Many lectures have automatically graded “exercises”. Here the students are
      asked to write queries in SQL, Relational Algebra, Xquery, or XSLT. A
      query is typically run against a test database, and passes the automatic
      check if the result set is correct. (In some cases, cheating by
      hard-wiring the result is possible, but so cumbersome that one might as
      well supply a good solution.)
    </p>
    <p>There are simpler “core” exercises, and harder “challenge” exercises.</p>
    <p>I loved those exercises and found them almost addictive.</p>
    <h3>The exams</h3>
    <p>
      There was mid-term exam and a final exam. Both were multiple choice, open
      for three days, and once started, had to be finished within (generous) two
      hours.
    </p>
    <h3>The forum</h3>
    <p>
    ...
    <p>
      ...
      Accomplishment” showing how they performed. Unsurprisingly, this statement
      has no official character: because there was no face-to-face
    ...
    <p>
      ...
      effort, one can obtain a “distinction”. Because the quizzes and exams are
      well designed, a better score really means better understanding, so aiming
      for a good score is a worthy goal.
    </p>
    <p>
      I was probably an atypical student in this course: on the one hand, I had
      the privilege of an extremely strong academic education in computer
      science, at several universities, and that helped me a lot. On the other
      hand, my ambitions went way beyond the distinction boundary, and that cost
      me a lot of time. All in all, I spent ca. 130 hours, including everything:
      videos, quizzes, exercises, and exams plus preparation. That amounts to
      ca. 14 hours a week. A complete computer-science beginner may have to work
      hard to pass the course. By contrast, a professional software engineer
      would probably pass with moderate effort, and require maybe 10 hours a
      week for a distinction. If you want to get every detail right, it gets a
      lot harder.
    </p>
    <h2>Was it worth it?</h2>
    <p>
      After this course, I feel more confident when dealing with databases,
      despite the fact that I had a lot of previous experience. I also gained a
      much better understanding of the area of databases in the widest sense.
      Plus, I satisfied my curiosity about how it feels to partake in a top
    ...
    <p>
      This verification is trivial for multiple-choice questions, but even there
      the student benefits from the immediacy of the feedback.
    </p>
    <p>
      ...
      <b>gamification</b>: the learning process can feel as addictive as a good
      (computer) game. (At least to those that like games.)
    </p>
    <p>
    ...
    <p>
      ...
      unit tests. (A unit test is another piece of code, which pretends to be a
      user of the production code and checks if the latter behaves as expected.)
      Similarly to <b>unit tests</b>, the exercise-checker in Widom’s course
      checks the students’ code (queries written in SQL, XSLT, and the like), by
      inspecting the result set. So it is similar to a unit test, except that in
      typical unit test scenarios, the code is a non-declarative programming
      language like Java, and not a declarative one like SQL. So:{" "}
      <b>
        One could create a great programming course by introducing automatic
        exercises where the student has to beat unit tests! Knowing the extreme
        importance of test-driven design from first-hand experience, I am sure
        that this alley should be explored.
      </b>
    </p>
    <h2>Final words</h2>
    <p>
      Prof. Widom mentioned once that turning her existing database course into
      an online one was an incredible amount of work. Having been a lecturer
      myself, I can easily believe that. Her achievement makes me feel gratitude
      and admiration. She surely is not the first or only person to set up such
      a course; all such people are heroes to me.
    </p>
    <h1>Comments</h1>
    <Comment author="Willem Schaap" date="2013-03-28">
      <p>
        There are already quite a number of well-designed online programming
        courses which have excellent unit tests. At Udacity, check out Intro to
        Computer Science and Design of Computer Programs. At Coursera, check out
        Algorithms I and II, these have the best tests I have seen so far.
      </p>
    ...
    <Comment author="Clifford GREGORY" date="2013-04-08">
      ...
      <p>
        Also, you are probably aware of the the database course, Datenmanagement
        mit SQL, offered by the Hasso Plattner Institut (HPI), which is
        described here:
      </p>
      <p>
        <LinkedReference target="https://openhpi.de/course/sql">
          https://openhpi.de/course/sql
        </LinkedReference>
      </p>
      ...
      <p>
        ...
        course just to see how its quizzes and exercises compare to those of the
        Stanford course. Unlike the videos, I figure the quizzes and exercises
        will have printed text that Google Chrome can translate for me, however
        crudely, so I have some access to that content.
      </p>
      <p>
        I think I saw somewhere that the instructor, Dr. Felix Naumann, is using
        the same Ullman/Molina/Widom textbook as the Stanford course. If so, it
        will be interesting to see which topics Dr. Naumann chooses to emphasize
        in this six-week course. I hope he will include extended remarks about
        recent developments with NoSQL databases, such as Hadoop, MongoDB, and
        Cassandra.
      </p>
      <p>Best regards.</p>
      ...
      <Comment author="Carsten Führmann" date="2013-04-08">
        <p>
          Thanks Clifford! Someone had already made me aware of the Gamification
          course, but I didn’t know about the HPI one. I’d be grateful for a
          one-paragraph review once you’re through.
        </p>
        <p>
          On a more personal note, this stimulating business of online courses
          makes me wonder about work-life balance, that is: given the work load
          of my full-time day job, how much time will I spend in the future on
          online-learning? I haven’t sorted this out yet. But I must admit that
          currently I need a break, some evenings when I haven’t planned
          anything.
        </p>
      </Comment>
    </Comment>
