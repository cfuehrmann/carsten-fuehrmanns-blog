...
const StanfordQuantum = () => (
  <Layout page={meta.target}>
    ...
    <p>
      ...
      review, including the overall syllabus, and an account of my personal
      experience.
    </p>
    <p>
      <Image
    ...
    <p>
      ...
      questions were aimed at conceptual understanding. Quite a few others asked
      for results of calculations.
    </p>
    ...
    <p>
      I’m sure the difficulty of these courses, and the workload, differ wildly
      depending on the students background. I can speak only of myself here. I
      have a good mathematical background, though I’m not specialized on the
      kind maths that prevails in physics, like differential equations, Taylor
      series, etc. I knew little about quantum physics before the course. But I{" "}
      <em>had</em> studied some classical mechanics.
    </p>
    ...
    <p>
      In classical mechanics, one may encounter hard maths; but one has usually
      a clear idea of the real life phenomena. For example, it may be hard to
      calculate the trajectory of a bouncing elastic ball. Or there may be no
      analytic way to deal with the three-body problem. But these things can be
      pictured easily in the mind.
    </p>
    ...
    <p>
      ...
      disorienting. For example, an electron can be seen as a moving wave packet
      that results from a superposition of single-frequency waves. Each of those
      single-frequency waves moves at a certain speed, the ‘phase velocity’; but
      the whole electron is construed to move at a different speed, the ‘group
      velocity’, which results from the superposition. Also, the electron is not
      clearly localized in space. Now imagine a discussion of a crystal that
      contains many electrons. As you see, it’s easy for a beginner to get lost
      when trying to visualize these things. (Ultimately, electrons in a crystal
      are accounted for by a ‘band structure’, which is very different from a
      bunch of classical particles moving about.)
    </p>
    ...
    <p>
      ...
      day job? Well, my motivation was to fill white spaces on my mental map of
      science, and to learn more about the inner workings of nature. I think
      this was mostly a success. Some things I understood very well, like the
      hydrogen atom. Others things I still need to understand better, like
      electromagnetic fields. But I have surely learned how quantum mechanics
      ticks. Now I only need to stay in touch with the material, lest it fade
      from my memory…
    </p>
  </Layout>
);
